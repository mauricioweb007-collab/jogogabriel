...
### 8.6 Segundo ajuste: Colunas, Quermesse e Estrada (24/09/2026, pedido do usuário)
| Jogo | Problema relatado | O que mudou |
|---|---|---|
| Colunas do Mosaico | A velocidade não aumentava; parecia acabar na primeira perda | O **nível sobe a cada 6 combinações** (cada grupo limpo conta, inclusive as correntes), e a queda fica 14% mais rápida por nível (mínimo 0,12 s). O painel mostra "NÍVEL n • próximo em x combinações". **3 vidas de verdade:** ao encher o tabuleiro, o jogo **para 2 s** com o aviso "TABULEIRO CHEIO! Vida perdida — restam n", limpa só a **metade de cima** e continua. Antes, o tabuleiro inteiro sumia na hora e parecia fim de jogo. A queda rápida (E) numa coluna cheia também conta como tabuleiro cheio. |
| Quermesse Tiro ao Alvo | Pedido: tiros limitados e passar de rodada ao bater a meta | **Rolhas = o dobro da meta** (meta 7 = 14 rolhas; meta 10 = 20), sem recarga. **Bateu a meta, passa na hora** para a próxima rodada, com bônus pelas rolhas e segundos que sobraram. **Acabaram as rolhas** (ou o tempo) sem bater a meta, o jogo termina. |
