...
> Arquivo GERADO por `node src/tools/gen-minigames-md.cjs` em 2026-09-24. Não edite à mão: edite os arquivos em `src/modules/geografia/scenes/` e rode o gerador de novo.
