...
(function () {
  ...
  const STAGES = [
    ...
    ['b1', 'Corrida Relâmpago', 'Desafio opcional contra o GeoBot', 1, 'bonus'], ['b2', 'Ritmo Livre', 'Desafio opcional de ritmo', 2, 'bonus'], ['b3', 'Labirinto Relâmpago', 'Desafio opcional de labirinto', 3, 'bonus']
  ];
